    ...
    <div className="bg-background min-h-screen pb-24">
      ...
      <div className="bg-white border-b border-border/40 pt-12 pb-24">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-foreground">Shop by Category</h1>
          <p className="text-lg text-muted-foreground max-w-2xl">Explore our curated collections and find exactly what you need for your device.</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-12">
        {(!categories || categories.length === 0) ? (
          <div className="text-center py-32 bg-white border border-border/40">
            <h3 className="text-sm uppercase tracking-widest font-bold mb-2">No categories found</h3>
